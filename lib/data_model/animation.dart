...
List<Animation> animationsData = [
  Animation(
    name: "Idle Show",
    key: "Armature|Armature|Idleshow|Base Layer",
    isChosen: false,
  ),
  Animation(
    name: "Come",
    key: "Armature|Armature|Come|Base Layer",
    isChosen: false,
  ),
  Animation(name: "Idle", key: "Idle", isChosen: true),
  Animation(name: "Breath", key: " Breath", isChosen: true),
  ...
  Animation(
    name: "Roar",
    key: "SK_Huggy|A_Huggy_Roar_SK_Huggy",
    isChosen: false,
  ),
  Animation(
    name: "Mini Turn",
  ...
  Animation(
    name: "Walk",
    key: "SK_Huggy|A_Huggy_Walk_SK_Huggy",
    isChosen: false,
  ),
  Animation(
    name: "Walk Backwards",
